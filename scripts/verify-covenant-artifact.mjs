...
const startRefund = round.abi.find((entry) => entry.name === "startRefund");
assert(startRefund?.inputs[0]?.name === "refund_transition_fee", `${round.contract} accepts a measured refund transition fee`);
