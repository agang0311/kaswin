...
docker run --rm -p 8787:8787 -v kaswin-indexer-data:/data `
...
| 环境变量 | 默认值 | 用途 |
| --- | --- | --- |
| `KASPA_RPC_URL` | `wss://vector-10.kaspa.green/kaspa/testnet-10/wrpc/borsh` | Kaspa wRPC 节点 |
| `KASPA_NETWORK` | `testnet-10` | `mainnet` 或 Testnet 10 的 SDK 网络 ID `testnet-10` |
| `RAFFLE_INDEX_HOST` | `127.0.0.1` | HTTP 监听地址；远程或容器部署使用 `0.0.0.0` |
| `RAFFLE_INDEX_PORT` | `8787` | HTTP 监听端口 |
| `RAFFLE_INDEX_DATA` | `.index-data` | 持久化目录 |
