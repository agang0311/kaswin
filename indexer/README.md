...
```powershell
git clone https://github.com/agang0311/kaswinndexer.git
cd kaswinndexer
npm ci
...
```powershell
docker build -t kaswinndexer .
docker run --rm -p 8787:8787 -v kaswinndexer-data:/data `
